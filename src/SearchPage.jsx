...
function SearchPage() {
  return (
    <div className="searchPage">
      ...
      <hr />
      <ChannelRow
        image="https://avatars.githubusercontent.com/u/43782909?v=4"
        channel="Oueis Frioui"
        verified
        subs="12K"
        noOfVideos={20}
        description=" Programmer Think and Grow Rich Programmer Think and Grow Rich Programmer Think and Grow Rich Programmer Think and Grow Rich Programmer Think and Grow Rich Programmer Think and Grow Rich "
      />
      <hr />
      <VideoRow
        views="1.4M"
